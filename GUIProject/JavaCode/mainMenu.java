...
public class mainMenu extends JFrame {
    ...
    public mainMenu() {
       ...
       // add ActionListener to logout button
        ...
        Adds an ActionListener to the logout button. When the button is clicked, this method displays a confirmation
        dialog to ask the user if they really want to logout. If the user confirms, this method disposes of the current
        mainMenu window and opens a new instance of the loginScreen to allow a different user to log in.
        @param e the ActionEvent object generated by clicking the logout button
        */
       logoutButton.addActionListener(new ActionListener() {
        ...
        parambutton the JButton to set the size of
        paramwidth the desired width of the button
        paramheight the desired height of the button
        */
    ...
    The main entry point of the program. Creates a new mainMenu object to display the main menu window.
    */
